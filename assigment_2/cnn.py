...
class ThreeLayerConvNet(object):
    ...
    def __init__(self, input_dim=(3, 32, 32), num_filters=32, filter_size=7,
        ...
        C,HH,WW,F=3,filter_size,filter_size,num_filters
        H_out=input_dim[1]/2
        W_out=input_dim[2]/2
        self.params['W1']=weight_scale*np.random.randn(F,C,HH,WW)
        self.params['b1']=np.zeros(F)
        self.params['W2']=weight_scale*np.random.randn(int(F*H_out*W_out),hidden_dim)
    ...
    def loss(self, X, y=None):
        ...
        dx,dw3,db3=affine_backward(soft_grad,cache3)
